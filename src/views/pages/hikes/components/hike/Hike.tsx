...
import { useDispatch } from "../../../../../store/storeConfig/rootReducers";
...
import { TypeProps_CreateHike } from "./ContainerHike";
...
const CreateHike: React.FC<TypeProps_CreateHike> = ({
  ...
  const isAuthUser = () => {
    if (!user.auth) {
      dispatch(showModal(modalsName.SING_UP_ALL));
    }
  };
    ...
    <>
      <Container className={classes.page}>
        <Typography
          variant="h5"
          gutterBottom
          className={classes.backToHike}
          onClick={handleBackToHikes}
        >
          <ArrowBackIcon className={classes.arrowBackIcon} /> Back to Hikes
        </Typography>
