...
const HikeList = () => {
    ...
    if (hikes) {
        ...
        hikeList = listHike.slice(gap.from, gap.to).map((hike: Ihike, index: number) => {
            return (
                    ...
                    <Paper elevation={0} className={classes.filter}>
                        ...
                        <div className={classes.dateRegion}>
                            ...
                            <div className={classes.region}>
                                <RegionCountry setValue={setValue} errors={errors} control={control}
                                               valueCountry={valueCountry} valueRegion={valueRegion}
